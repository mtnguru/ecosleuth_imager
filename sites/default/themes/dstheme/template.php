 ...
 * 1. Rename each function and instance of "dstheme" to match
...
function dstheme_preprocess_html(&$vars) {
  global $theme_key;
...
function dstheme_process_html(&$vars) {
}
// */
...
function dstheme_preprocess_page(&$vars) {
}
function dstheme_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dstheme_preprocess_node(&$vars) {
}
function dstheme_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dstheme_preprocess_comment(&$vars) {
}
function dstheme_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function dstheme_preprocess_block(&$vars) {
}
function dstheme_process_block(&$vars) {
}
// */


function dstheme_preprocess_link(&$variables) {
//if (is_array($variables['options']['attributes']['class'])) {
   $linkname = $variables['text'];
   if (!preg_match('?/?',$linkname)) {
      $name = preg_replace('/-+/','-',preg_replace('/[^A-Za-z0-9]/','-',$variables['text']));
      if (isset($variables['options']['attributes']['class'])) {
         if (is_array($variables['options']['attributes']['class'])) {
           $variables['options']['attributes']['class'][] = "ds-$name";
         }
      } else {
         $variables['options']['attributes']['class'][] = "ds-$name";
      }
 ...
 */
/*
function dstheme_superfish_menu_item($variables) {
 ...
 */
function dstheme_preprocess_views_view_summary(&$vars) {
 ...
 */
function dstheme_preprocess_views_view(&$vars) {
  $view = $vars['view'];
...
//  drupal_add_js(drupal_get_path('theme', 'dstheme') . '/image-popup.js');
    // add needed stylesheet
//  drupal_add_css(drupal_get_path('theme', 'dstheme') .'/image-popup.css');
  }
}


function dstheme_preprocess_views_view_field(&$vars) {
  $view = $vars['view'];
  // if the view has a class of ds-images
...
//function dstheme_fieldset(&$vars) {
 ...
 * @ingroup themeable
 */
function dstheme_form_element($variables) {
  $element = &$variables['element'];
...
function dstheme_preprocess_form (&$vars) {
  return;
}

function dstheme_preprocess_fieldset (&$vars) {
  return;
}


function dstheme_preprocess_form_element (&$vars) {
