...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <!-- Sorensen - don't output main menu  ?php if ($primary_navigation): print $primary_navigation; endif; ? -->
  <!-- Sorensen - don't output user menu  ?php if ($secondary_navigation): print $secondary_navigation; endif; ? -->
