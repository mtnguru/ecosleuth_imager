...
away from the main ecoMedia and allow you to literally copy and paste into your own project.
...
You can add ecoMedia entities via
...
searching and replacing the word "ecoMedia" with the actual name I want to give my
entity and the base entity table and then adding the domain specific functionality.

It would be nice if this could ecoMediaually develop in something that is automated
...
ecoMedia.admin.inc and customize the behaviour of your entity on save, delete which you
do via the TicketController class in ecoMedia.module.
...
to your table)  - just like the ecoMedia entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $ecoMedia->create but not necessarily $ecoMedia->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into ecoMedia.tpl.php and
ecoMedia-sample-data.tpl.php
